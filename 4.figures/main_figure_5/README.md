...
1. [1.find_sc_crops_top_feat.ipynb](./1.find_sc_crops_top_feat.ipynb): Find the 6 top maximum and minimum representative single cells for each of the two most weighted features, both representative in predicting WT genotype.
